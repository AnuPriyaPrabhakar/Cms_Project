...
class SearchService {
  ...
  getRegulator = async () => {
    try {
      const response = await this.httpClientWrapper.get('/api/v1/Regulator');
      return response;
    } catch (error) {
      throw error;
    }
  ...
  getRegulatorList = async () => {
    try {
      const response = await this.httpClientWrapper.get('/api/v1/RegulatorList');
      return response;
    } catch (error) {
      throw error;
    }
  ...
  getRecoredType = async () => {
    try {
      const response = await this.httpClientWrapper.get('/api/v1/RecordType');
      return response;
    } catch (error) {
      throw error;
    }
  ...
  getBank = async () => {
    try {
      const response = await this.httpClientWrapper.get('/api/v1/Bank');
      return response;
    } catch (error) {
      throw error;
    }
  ...
  getContactDetails = async () => {
    try {
      const response = await this.httpClientWrapper.get('/api/v1/ContactDetails');
      return response;
    } catch (error) {
      throw error;
    }
  ...
  getCountryHq = async () => {
    try {
      const response = await this.httpClientWrapper.get('/api/v1/CountryHq');
      return response;
    } catch (error) {
      throw error;
    }
  ...
  getCustomer = async (cmsId: string) => {
    try {
      const response = await this.httpClientWrapper.get(`/api/v1/DetailSave/GetDetails/${cmsId}`);
      return response;
    } catch (error) {
      throw error;
    }
