...
export interface createCompanyAliasesRequests {
  recordTypeId: number;
  cmsId: number
  companyId: number;
  aliasesName: string;
...
export interface CompanyCombineDTO {
  //companyAliasesDTOS: any;
  companyDetailsDTOS: CompanyDetailsDTOS;
  companyAliasesDTOS: CompanyAliasesDTOS[];
};


export interface CompanyPayload {
  companyCombineDTO: CompanyCombineDTO[];
};

export interface CompanyDetailsDTOS {
  cmsId: number;
  recordTypeId: number;
...
export interface CompanyAliasesDTOS {
  cmsId: number;
  recordTypeId: number;
  companyId: number;
  aliasesName: string;
