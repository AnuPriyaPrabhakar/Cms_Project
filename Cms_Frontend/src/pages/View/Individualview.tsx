...
import { bank, State, createDetailsRequest, Regulator, RegulatorListData, Gender, RecordTypeData, Dead, InorgPayload, AliasesDTO, AddressDTO, DateOfBirthDTO, DetailsCombineDTO, CreateCountryRegistrationRequest, IdNumberData, CountryHqData, Country, CreateCaseDetailsRequest, createBankDetailsRequests, createCompanyDetailsRequests, createCompanyAliasesRequests, createIndPositionsRequests, createIndCaseDetailsRequests, ContactDetailsData, RelativeConfigData, CompanyPayload } from '../../data/services/Search/search-payload';
...
const Individualview: React.FC = () => {
    ...
    const [showCompanyAliasesDetails, setShowCompanyAliasesDetails] = useState(false);
    ...
    const renderColumnValue = (columnName: string, DetailsData: any, PartyformData: any) => {
        switch (columnName) {
            ...
            //                                                     <TableCell>{company.companyAliasesDTOS.length > 0 ? company.companyAliasesDTOS.map((alias) => alias.aliasesName).join(', ') : 'Not Available'}</TableCell>
            //                                                 </TableRow>
            //                                             </TableBody>
            //                                         </Table>
            //                                     </TableContainer>
