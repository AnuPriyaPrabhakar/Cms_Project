...
import { Box, TextField, Button, Grid, InputLabel, FormControl, Select, MenuItem, FormControlLabel, Checkbox } from '@mui/material';
...
import { createDetailsRequest, Regulator, RegulatorListData, Gender, RecordTypeData, Dead, InorgPayload, bank, AliasesDTO, AddressDTO, DateOfBirthDTO, DetailsCombineDTO, CreateCountryRegistrationRequest, IdNumberData, CountryHqData, Country, CreateCaseDetailsRequest, createIndPositionsRequests, createIndCaseDetailsRequests, createBankDetailsRequests, createCompanyDetailsRequests, State, ContactDetails, CompanyPayload } from '../../data/services/Search/search-payload';
...
function Edited() {
    ...
    //     updatedFormData[personIndex].stateId = value;
    //     setCompanyFormData(updatedFormData);
    // };

    // const handleidentificationNumberId = (personIndex: number, value: number) => {
    //     const updatedFormData = [...companyformData];
    //     updatedFormData[personIndex].identificationNumberId = value;
    //     setCompanyFormData(updatedFormData);
    // };

    // const handleInputChangompany = (personIndex: number, event: React.ChangeEvent<HTMLInputElement>) => {
    //     const updatedFormData = [...companyformData];
    //     updatedFormData[personIndex].role = event.target.value;
    //     setCompanyFormData(updatedFormData);
    // };

    // const handleRemoveBoxcompanydetails = (personIndex: number) => {
    //     const updatedFormData = [...companyformData];
    //     updatedFormData.splice(personIndex, 1);
    //     setCompanyFormData(updatedFormData);
    // };

    // const handleInputChagecompanyDetails = (personIndex: number, event: React.ChangeEvent<HTMLInputElement>) => {
    //     const updatedFormData = [...companyformData];
    //     updatedFormData[personIndex].companyName = event.target.value;
    //     setCompanyFormData(updatedFormData);
    // };

    // const handleInputChageaddressDetails = (personIndex: number, event: React.ChangeEvent<HTMLInputElement>) => {
    //     const updatedFormData = [...companyformData];
    //     updatedFormData[personIndex].address = event.target.value;
    //     setCompanyFormData(updatedFormData);
    // };

    // const handleInputChageidDetailsDetails = (personIndex: number, event: React.ChangeEvent<HTMLInputElement>) => {
    //     const updatedFormData = [...companyformData];
    //     updatedFormData[personIndex].idDetails = event.target.value;
    //     setCompanyFormData(updatedFormData);
    // };
    ...
    //     const selectedRegulatorId = event.target.value as string;
    //     setRegulatorId(selectedRegulatorId);
    //     const selectedRegulator = Regulator.find(item => item.id.toString() === selectedRegulatorId);
    //     if (selectedRegulator) {
    //         setDetailsData(prevDetailsData => ({
    //             ...prevDetailsData,
    //             regulatorListId: selectedRegulator.regulatorListId,
    //             regulatorId: selectedRegulator.id,
    //         }));
    //     }
    // };
    const handleRegulatorChange = (event: { target: any; }) => {
    ...
    const handleEdit = async (cmsId: number, imgName: string, pathId: number) => {
        try {
            ...
            if (!isAnyCheckboxSelected) {
                setCheckboxError('Please select at least one checkbox to Edit');
                return;
            }
                                                ...
                                                <form key={index} encType="multipart/form-data">
                                                    <div>
                                                        <div className="field-group-column">
                                                            <input
                                                                ...
                                                                multiple
                                                            />
                                                            <Button variant="outlined" onClick={() => handleChooseImagesClick1(index)}>Photo</Button>
                                                            <TextField label="Attachement" type="text" size="small" variant="outlined" value={image.name} disabled />
                                                        </div>
                                                    </div>
                                                    <Col xs={1}>
                                                    ...
                                                    {/* {base64Images && (
                                                        <Col xs={12} style={{ marginTop: '2%' }}>
                                                            <div>
                                                                <h2>Image Preview</h2>
                                                                <Image src={base64Images} alt="Preview" style={{ maxHeight: '250px', maxWidth: '300px' }} />
                                                            </div>
                                                        </Col>
                                                    )}
                                                </form>
                                        ...
                                        <div>
                                            ...
                                            <Grid container spacing={1}>
                                                <Grid item xs={12}>
                                                    <FormControlLabel
                                                        control={
                                                            <Checkbox style={{ color: 'red' }} checked={includeImageRequest} onChange={handleChangeCheckbox} name="includeImageRequest"
                                                            />
                                                        }
                                                        label="Image Edit" style={{ color: 'red' }}
                                                    />
                                                </Grid>
                                            </Grid>
                                        </div>
                                        ...
                                        <div className="field-group">
                                            {images.map((image, index) => (
                                                <form key={index} encType="multipart/form-data">
                                                    ...
                                                    <Col xs={1}>
                                                        <div onClick={() => handleIndividualClick(parseInt(cmsId || '0', 10), 2, 'image')}>
                                                        </div>
                                                    </Col>
                                                    {/* {base64Image && (
                                                        <Col xs={12} style={{ marginTop: '2%' }}>
                            ...
                            <Grid item xs={4}>
                                <div className="key">
                                        ...
                                        <div className="field-group">
                                            {images.map((image, index) => (
                                                <form key={index} encType="multipart/form-data">
                                                    ...
                                                    <Col xs={1}>
                                                        <div onClick={() => handleShipClick(parseInt(cmsId || '0', 10), 3, 'image')}>
                                                        </div>
                                                    </Col>
                                                    {/* {base64Imageship && (
                                                        <Col xs={12} style={{ marginTop: '2%' }}>
                                                            <div>
                                                                <h2>Image Preview</h2>
                                                                <Image src={base64Imageship} alt="Preview" style={{ maxHeight: '250px', maxWidth: '300px' }} />
                                                            </div>
                                                        </Col>
                                                    )}
                                                </form>
                                    ...
                                    <Col xs={12} style={{ marginTop: '2%' }}>
                                        <div>
                                            <h2>Image Preview</h2>
                                            <img src={base64Imageship} alt="Preview" style={{ maxHeight: '250px', maxWidth: '300px' }} />
                                        </div>
                                    </Col>
                                )}
                                {pdfData.base64 && (
                            ...
                            <Grid item xs={4}>
                                <div className="key">
                                        ...
                                        <div className="field-group">
                                            {images.map((image, index) => (
                                                <form key={index} encType="multipart/form-data">
                                                    ...
                                                    <Col xs={1}>
                                                        <div onClick={() => handleAirCraftClick(parseInt(cmsId || '0', 10), 4, 'image')}>
                                                        </div>
                                                    </Col>
                                                    {/* {base64Imageair && (
                                                        <Col xs={12} style={{ marginTop: '2%' }}>
                                                            <div>
                                                                <h2>Image Preview</h2>
                                                                <Image src={base64Imageair} alt="Preview" style={{ maxHeight: '250px', maxWidth: '300px' }} />
                                                            </div>
                                                        </Col>
                                                    )}
                                                </form>
                                    ...
                                    <Col xs={12} style={{ marginTop: '2%' }}>
                                        <div>
                                            <h2>Image Preview</h2>
                                            <img src={base64Imageair} alt="Preview" style={{ maxHeight: '250px', maxWidth: '300px' }} />
                                        </div>
                                    </Col>
                                )}
                                {pdfData.base64 && (
                        ...
                        >
                            <Box m={2}>
                                <Grid container spacing={3}>
                                    <Grid item xs={4}>
                                        <FormControl style={{ width: '100%' }}>
                                            ...
                                            <Select
                                                ...
                                                value={DetailsData.regulatorId.toString()} // Ensure value is converted to string
                                                disabled={!updateCheckingData.detailsEdit}
                                            >
                                                {Regulator.map((item) => (
                                                    <MenuItem
                                    ...
                                    <Grid item xs={4}>
                                        <FormControl style={{ width: '100%' }}>
                                            ...
                                            <Select
                                                ...
                                                value={DetailsData.regulatorListId.toString()} // Ensure value is converted to string
                                                disabled={!updateCheckingData.detailsEdit}
                                            >
                                                {Regulatorlist.map((item) => (
                                                    <MenuItem
                                    ...
                                    <Grid item xs={4}>
                                        <FormControl style={{ width: '100%' }}>
                                            <InputLabel htmlFor="gender">Record Type</InputLabel>
                                            <Select
                                                label="Regulator"
                                                variant="standard"
                                                value={recordTypeId}
                                ...
                                {/* <button
                                    ...
                                    onClick={() => {
                                        if (cmsId !== undefined) {
                                            ...
                                            console.error('cmsId is undefined');
                                        }
                                    }}
