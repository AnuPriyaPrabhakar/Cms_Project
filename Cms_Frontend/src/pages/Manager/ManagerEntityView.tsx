...
import { faUserCircle, faRecordVinyl, faRegistered, faFile, faUser, faFlag, faAddressCard, faExternalLinkAlt, faPerson, faBalanceScale, faTimes, faUniversity } from '@fortawesome/free-solid-svg-icons';
import Header from '../../layouts/header/header';
import 'jspdf-autotable';
import { bank, createDetailsRequest, Regulator, RegulatorListData, RecordTypeData, Dead, InorgPayload, AliasesDTO, AddressDTO, DateOfBirthDTO, DetailsCombineDTO, CreateCountryRegistrationRequest, IdNumberData, CountryHqData, Country, CreateCaseDetailsRequest, createBankDetailsRequests, createCompanyDetailsRequests, createIndPositionsRequests, createIndCaseDetailsRequests, RelativeConfigData, ContactDetailsData } from '../../data/services/Search/search-payload';
...
const ManagerEntityview: React.FC = () => {
    ...
    const backendColumns = ['RecordType', 'Source Link', 'Regulator', 'RegulatorList', 'Name', 'Aliases Name', 'Address', 'Country Details', 'Individual Details', 'Case Details', 'Case Detail', "Bank Details"];
                        ...
                        >
                            <Box m={4}>
                                <Grid container justifyContent="space-between" alignItems="center">
                                    <Grid item>
                                        <h4 style={{ marginBottom: '1%' }}>MANAGER ENTITY VIEW</h4>
                                    </Grid>
                                </Grid>
...
export default ManagerEntityview;