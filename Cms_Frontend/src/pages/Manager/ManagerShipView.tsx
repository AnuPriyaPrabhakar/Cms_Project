...
import { createDetailsRequest, Regulator, RegulatorListData, Gender, RecordTypeData, Dead, InorgPayload, AliasesDTO, AddressDTO, DateOfBirthDTO, DetailsCombineDTO, CreateCountryRegistrationRequest, IdNumberData, CountryHqData, Country, CreateCaseDetailsRequest } from '../../data/services/Search/search-payload';
...
const ManagerShipview: React.FC = () => {
                        ...
                        >
                            <Box m={4}>
                                <Grid container justifyContent="space-between" alignItems="center">
                                    <Grid item>
                                        <h4 style={{ marginBottom: '1%' }}>MANAGER SHIP VIEW</h4>
                                    </Grid>
                                </Grid>
...
export default ManagerShipview;