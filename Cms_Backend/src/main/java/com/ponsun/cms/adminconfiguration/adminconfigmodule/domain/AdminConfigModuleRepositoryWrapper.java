package com.ponsun.cms.adminconfiguration.adminconfigmodule.domain;

import com.ponsun.cms.adminconfiguration.adminconfigmodule.request.AbstractAdminConfigModuleBaseRequest;
...
//        return this.adminConfigModuleRepository.findBycmsId(id).orElseThrow(() -> new EntityNotFoundException("AdminConfigModule Not found " + id));
//    }
    @Override
